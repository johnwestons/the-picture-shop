...
- Left storage uses four authored construction-stage sprites. Other projects show the floor surface or a translucent rack/breakroom site preview while the worker and stage label communicate progress. Those previews are not a substitute for final, option-specific construction atlases.
...
- Construction atlases for right-side storage, open floor and both breakroom orientations still need finished art, and all expansion art needs direct visual review in the running game before it can be approved for production. Rack/deck occlusion and complete stock variants also remain open.
