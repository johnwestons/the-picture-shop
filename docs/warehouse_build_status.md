...
## Art status: approved expansion modules; provisional vehicle and worker art
...
On September 26, 2026, the user approved the two-bay rack, breakroom and construction-stage art. Their presentation catalogs now mark those entries approved for ordinary gameplay. `Config.warehouse.provisionalArt=true` remains enabled for the separate forklift and construction-worker artwork, which still carries the development-art notice.
...
- Both storage orientations and both breakroom orientations now have distinct four-stage construction art. The user approved this module and construction art on September 26. Open-floor construction shows the existing concrete surface with the stage label and worker. Placement scale, floor seams, collision footprints and rack/deck occlusion still need calibration in the running game.
...
- The user-approved expansion sprites still need in-game registration review for placement, seams, collision footprints and rack/deck occlusion. Complete stock variants remain open. Forklift and construction-worker art remain provisional.
