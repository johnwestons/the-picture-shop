...
RUNTIME_SOURCE_ASSETS = tuple(
    ...
    for relative in (
        ...
        "forklift-layer-study/east-fixed-manned-v1.png",
        "forklift-layer-study/east-fixed-empty-v1.png",
        "forklift-layer-study/east-carriage-v2.png",
        "forklift-layer-study/southeast-fixed-manned-v1.png",
        "forklift-layer-study/southeast-fixed-empty-v1.png",
        "forklift-layer-study/southeast-carriage-v1.png",
        "forklift-layer-study/northeast-fixed-manned-v1.png",
        "forklift-layer-study/northeast-fixed-empty-v1.png",
        "forklift-layer-study/northeast-carriage-v2.png",
        "forklift-layer-study/south-fixed-manned-v1.png",
        "forklift-layer-study/south-fixed-empty-v1.png",
        "forklift-layer-study/south-carriage-v1.png",
        "forklift-layer-study/north-fixed-manned-v1.png",
        "forklift-layer-study/north-fixed-empty-v1.png",
        "forklift-layer-study/north-carriage-v1.png",
